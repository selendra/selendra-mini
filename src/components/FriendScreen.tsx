  ...
  return (
    ...
    >
      <div className="bg-primary/50 p-4 rounded-lg">
        <Image
          src={bannerAirdrop}
          alt="Selendra Airdrop"
          width={200}
          height={100}
          className="w-full mb-4"
        />
        <h2 className="text-xl font-bold mb-2 text-white">
          Invite Friends with Selendra mini & Earn SEL
        </h2>
        <p className="text-sm text-white">
          Invite more friends to earn more SEL
        </p>
      ...
      >
        <Image
          src="https://img.icons8.com/arcade/64/trophy.png"
          alt="Trophy"
          width={50}
          height={50}
        ...
        <h3 className="text-lg font-bold mb-2 text-white">
          Earn 10% of the Points your friend earns as a Referral Bonus
        </h3>
