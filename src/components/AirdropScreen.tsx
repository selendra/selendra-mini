      ...
      <motion.main className="p-4" variants={itemVariants}>
        ...
        >
          ...
          <p className="text-sm text-gray-400 mt-2">
            *If you have already sent a transaction, go to the quest and click «Check Action» there. Open Quest
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          whileTap={{ scale: 0.95 }}
        >
          <span className="font-semibold">Instructions on how to connect a wallet</span>
        </motion.div>
        ...
        <motion.p className="text-sm" variants={itemVariants}>
          Currently, we are in the mining stage, where all players are developing their characters to earn more tokens for the airdrop. The planned date for the airdrop is late September to early October.
        </motion.p>
      </motion.main>
    </motion.div>
  );
